...
@section('home_page')
     <!-- Hero Slider Begin -->
    <div class="banner-slider" style="margin-top: -10px">
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" style="margin-top: -15px;">
                ...
                <div class="carousel-item">
                <img class="d-block w-100" src="{{asset('frontend/img/slider-3.jpg')}}" alt="Third slide"/>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row" id="product-list">
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses shoes">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{asset('frontend/img/products/img-5.jpg')}}" alt=""></a>
                            <div class="p-status">new</div>
                        </figure>
                        <div class="product-text">
                            <h6>Green Dress with details</h6>
                ...
                <div class="col-lg-3 col-sm-6 mix all accesories bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{asset('frontend/img/products/img-6.jpg')}}" alt=""></a>
                            <div class="p-status sale">sale</div>
                        </figure>
                        <div class="product-text">
                            <h6>Yellow Maxi Dress</h6>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{asset('frontend/img/products/img-7.jpg')}}" alt=""></a>
                        </figure>
                        <div class="product-text">
                            <h6>One piece bodysuit</h6>
                            <p>$19.90</p>
                ...
                <div class="col-lg-3 col-sm-6 mix all accesories bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{asset('frontend/img/products/img-8.jpg')}}" alt=""></a>
                            <div class="p-status popular">popular</div>
                        </figure>
                        <div class="product-text">
                            <h6>Blue Dress with details</h6>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="lookbok-pic">
                        <img src="{{asset('frontend/img/lookbok.jpg')}}" alt="">
